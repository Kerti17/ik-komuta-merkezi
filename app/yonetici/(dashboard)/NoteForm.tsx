...
import { createManagerNoteAction, type FormState } from "./actions";

export function NoteForm({ employeeId }: { employeeId: number }) {
  const [state, formAction] = useActionState<FormState, FormData>(createManagerNoteAction, undefined);
  ...
  return (
    <form ref={formRef} action={formAction} style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 10 }}>
      ...
      <div style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
        ...
        <textarea
          name="note"
          placeholder="Çalışanla ilgili notunuz..."
          required
